...
def upgrade() -> None:
    ...
    with op.batch_alter_table("query_logs", schema=None) as batch_op:
        batch_op.create_index(
            op.f("ix_query_logs_created_at"), ["created_at"], unique=False
        )
        batch_op.create_index(
            op.f("ix_query_logs_subject_id"), ["subject_id"], unique=False
        )
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table("query_logs", schema=None) as batch_op:
        batch_op.drop_index(op.f("ix_query_logs_subject_id"))
        batch_op.drop_index(op.f("ix_query_logs_created_at"))
