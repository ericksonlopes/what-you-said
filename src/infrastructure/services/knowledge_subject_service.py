...
class KnowledgeSubjectService:
    ...
    def get_or_create_by_external_ref(self, external_ref: str, name: Optional[str] = None,
                                      description: Optional[str] = None) -> KnowledgeSubjectEntity:
    ...
    def update_subject(self, id: UUID, name: Optional[str] = None,
                       description: Optional[str] = None, external_ref: Optional[str] = None) -> None:
        """Update fields of an existing subject."""
        self._repo.update(id=id, name=name, description=description, external_ref=external_ref)
