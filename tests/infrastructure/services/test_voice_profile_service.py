...
class TestVoiceDB:
    ...
    def mock_infra(self):
        ...
        with patch("src.infrastructure.services.voice_profile_service.StorageService") as mock_cls, \
    ...
    def test_remove_voice(self, sqlite_memory):
        ...
        v = VoiceRecord(id="1", name="Test", embedding=[0.1], audio_source="s3://bucket/voices/test.wav")
        sqlite_memory.add(v)
    ...
    def test_add_voice_already_exists_reinforces(self, sqlite_memory):
        ...
        v = VoiceRecord(id="exists-123", name="Exists", embedding=[0.1, 0.1], audio_source="s3")
        sqlite_memory.add(v)
        sqlite_memory.commit()
