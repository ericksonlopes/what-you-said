...
class ErrSession:
    def get(self, *args, **kwargs):
        raise TestRepositoryError("get error")

    def query(self, *args, **kwargs):
        raise TestRepositoryError("query error")

    def add(self, *args, **kwargs):
        raise TestRepositoryError("add error")

    def commit(self, *args, **kwargs):
        raise TestRepositoryError("commit error")
...
def test_repositories_handle_exceptions(monkeypatch):
    ...
    with pytest.raises(TestRepositoryError):
